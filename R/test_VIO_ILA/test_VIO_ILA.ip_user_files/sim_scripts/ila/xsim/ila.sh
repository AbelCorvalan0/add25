...
simulate()
{
  xsim ila -key {Behavioral:sim_1:Functional:ila} -tclbatch cmd.tcl -protoinst "protoinst_files/ila.protoinst" -protoinst "protoinst_files/vio.protoinst" -log simulate.log
}
