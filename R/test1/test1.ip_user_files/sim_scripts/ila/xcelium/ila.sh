...
#
# Script generated by Vivado on Fri Nov 07 17:45:44 -03 2025
...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" +incdir+"../../../../test1.gen/sources_1/bd/ila/ipshared/5431/hdl/verilog" +incdir+"../../../../test1.gen/sources_1/bd/ila/ipshared/4e08/hdl/verilog" +incdir+"../../../../test1.gen/sources_1/bd/ila/ipshared/537f/hdl/verilog" +incdir+"../../../../test1.gen/sources_1/bd/ila/ipshared/d41f/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/abel/Documents/vivado_projects/test1/test1.cache/compile_simlib/xcelium"
  fi
