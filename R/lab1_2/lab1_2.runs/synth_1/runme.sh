...
HD_PWD='/home/abel/Documents/vivado_projects/lab1_2/lab1_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log operations.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source operations.tcl
