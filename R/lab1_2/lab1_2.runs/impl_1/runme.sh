...
HD_PWD='/home/abel/Documents/vivado_projects/lab1_2/lab1_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log operations.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source operations.tcl -notrace
